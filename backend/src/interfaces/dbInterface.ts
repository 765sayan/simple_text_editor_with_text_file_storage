...
export interface ShareFileDbInterface {
    ...
    deleteSecondaryOwnerOfFileForUserDelete(sharedFileId: string, secondaryOwner: any, fileName: any): any;

    deleteSecondaryOwnerOfFile(userId: string | JwtPayload, secondaryOwner: any, filename: string): any;

    getSharedFilesWithUser(userId: string | JwtPayload): any;

    shareFile(userId: string | JwtPayload, filename: string, secondaryOwner: any): any;
}